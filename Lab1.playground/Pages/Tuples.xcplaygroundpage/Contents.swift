...
var currencyUSD: (type: String, value: Double) = ("usd" , 1.00)
var currencyCAD: (type: String, value: Double) = ("cad" , currencyUSD.value * 1.29)
var currencyAUD: (type: String, value: Double) = ("aud" , currencyUSD.value * 1.36)
print("[\(currencyUSD.value)] [\(currencyUSD.type)] is [\(currencyCAD.value)] [\(currencyCAD.type)] is
      [\(currencyAUD.value)] [\(currencyAUD.type)]")
